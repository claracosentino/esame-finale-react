                ...
                <div className="container">
                    <p>L'evento inizia alle ore {hourStartEventFormatted}</p>
                    {
                        hourSlots.map((hour, i)=>{
                            return (
                                <>
                                    <button className='btn btn-solid' onClick={handleOpen}>{hour}</button>
                                    <Modal
                                        open={open}
                                        onClose={handleClose}
                                    ...
                                    >
                                        <Box sx={modalStyle}>
                                            <Typography sx={titleModalStyle} id="modal-modal-title" variant="h6" component="h2">
                                                Dacci tutti i tuoi dati per confermare
                                            </Typography>
                                            <form id="modal-modal-description">
                                                <label>
                                                    Nome:
                                                    <input type="text" name="nome" value={inputName} onChange={e => setInputName(e.target.value)}/>

                                                    Cognome:
                                                    <input type="text" name="cognome" value={inputCognome} onChange={e => setInputCognome(e.target.value)}/>
